...
namespace CDSPractical
{
    public class Questions
    {
        ...
        public IEnumerable<int> ExtractNumbers(IEnumerable<string> source)
        {
            ...
            //List<int> intList = source.Select(s => Int32.TryParse(s, out int n) ? n : (int?)null)
            //        .Where(n => n.HasValue)
            //        .Select(n => n.Value)
            //        .ToList();
        ...
        {
            List<string> matches = first.Intersect(second).ToList();
        ...
        {
            return word.Equals(word.ToLower().Reverse());
        }
        ...
        public IEnumerable<object> Shuffle(IEnumerable<object> source)
        {
            ...
            IEnumerable<object> result = source.OrderBy(item => rnd.Next());
            return result;
        }
