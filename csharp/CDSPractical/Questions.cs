...
namespace CDSPractical
{
    public class Questions
    {
        ...
        {
            var result = from word1 in first
                         join word2 in second
                         on word1 equals word2
                         orderby word1.Length descending
                         select word1;
        ...
        public int[] Sort(int[] source)
        {
            ...
            for (int i = 0; i < arrLen - 1; i++)
            {
                ...
                int temp = source[minValueIndex];
                source[minValueIndex] = source[i];
                source[i] = temp;
            }
